...
object SharedPrefKeys{
    ...
    const val PREF_KEY_IS_DARK_MODE_ON= "dark_mode"
    const val PREF_KEY_SELECTED_LANGUAGE_CODE= "selectedLangCode"
    const val PREF_KEY_IS_APP_OPENED_FIRST_TIME= "isAppFirstTimeOpened"
}