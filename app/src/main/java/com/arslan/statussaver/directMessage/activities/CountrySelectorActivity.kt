package com.arslan.statussaver.directMessage.activities
...
import com.arslan.statussaver.databinding.ActivityCountrySelectorBinding
import com.arslan.statussaver.directMessage.adapters.CountriesAdapter
...
class CountrySelectorActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = CountriesAdapter(filteredList, object : OnItemClickListener {
